...
const profileFunctions = {
    ...
    updateprofile : async function(param, callback) {
        axios.post("https://api.classicapp.online/users/profile",{type:"update" , location:param.location, description:param.description},{
    ...
    updateprofilephoto : async function(param, callback) {
       ...
       await axios.post("https://api.classicapp.online/users/profile",{type:"upload" , avatarPhoto:param.avatarPhoto},{
        httpsAgent: httpsAgent,
    ...
    refreshprofile: async function(param,callback){
        axios.get("https://api.classicapp.online/users/"+param._id,{
            httpsAgent: httpsAgent,
            headers:{ Authorization : 'Bearer '+param.token}
        }).then((response)=>{
            callback(false,response.data);
